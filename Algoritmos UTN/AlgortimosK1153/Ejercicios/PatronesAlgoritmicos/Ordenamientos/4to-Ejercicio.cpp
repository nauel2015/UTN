...
/* Ejercicio N°4:  Siendo Persona { int documento; string nombre}. Crear una función para ordenar un array de Persona por su nombre en
orden descendente utilizando el algoritmo de selección.
